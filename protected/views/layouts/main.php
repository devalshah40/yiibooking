                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="<?php echo Yii::app()->theme->baseUrl; ?>/dist/img/user2-160x160.jpg"
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="<?php echo Yii::app()->theme->baseUrl; ?>/dist/img/user2-160x160.jpg" class="img-circle"
                     alt="User Image">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo $this->createUrl('/user/profile'); ?>" class="btn btn-default btn-flat">Profile</a>
                </div>
