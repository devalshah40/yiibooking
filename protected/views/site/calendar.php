<?php
$d = Yii::app()->request->requestUri;
$csrfToken = Yii::app()->request->csrfToken;
Yii::app()->clientScript->registerScriptFile(Yii::app()->theme->baseUrl .'/plugins/fullcalendar/fullcalendar.min.js', CClientScript::POS_END);
?>
